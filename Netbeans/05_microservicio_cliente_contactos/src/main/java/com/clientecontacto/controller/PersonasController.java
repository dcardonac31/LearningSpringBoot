package com.clientecontacto.controller;
...
import com.clientecontacto.model.Persona;
...
public class PersonasController {
	...
	public ResponseEntity<List<Persona>> altaPersona(@PathVariable("nombre") String nombre,
		...
		try {
			...
			//diferente a 200, se producira una excepción
			...
			//si hubo un error en la llamada al microservicio, enviamos a nuestro cliente final
